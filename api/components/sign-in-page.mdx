...
```tsx
import { SignInPage } from 'simple-logto'
...
- [CallbackPage](/api/components/callback-page) - Handles the callback after authentication
- [AuthProvider](/api/components/auth-provider) - Configure authentication behavior
- [useAuth](/api/hooks/use-auth) - Access authentication state programmatically
