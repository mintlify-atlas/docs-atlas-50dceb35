...
```tsx
import { CallbackPage } from 'simple-logto'
...
- [SignInPage](/api/components/sign-in-page) - Initiates the sign-in flow
- [AuthProvider](/api/components/auth-provider) - Required context provider
