...
```tsx
import { useAuth } from 'simple-logto'
...
- [AuthProvider](/api/components/auth-provider) - Provider component required to use this hook
- [verifyAuth](/api/backend/verify-auth) - Backend authentication verification